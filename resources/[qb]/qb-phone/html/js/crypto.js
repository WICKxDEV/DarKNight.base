...
function SetupCryptoData(Crypto) {
  ...
  if (CryptoData.History.length > 0) {
    ...
    $.each(CryptoData.History, function (i, change) {
      ...
      var Element =
        ...
        '<span class="cryptotab-course-block-happening"><span style="font-size: 1.3vh;">LKR ' +
        change.PreviousWorth +
        '</span> to <span style="font-size: 1.3vh;">LKR' +
        change.NewWorth +
        "</span>" +
        PercentageElement +
        "</span>" +
  ...
  $(".crypto-course")
    .find("p")
    .html("LKR " + CryptoData.Worth);
  $(".crypto-volume")
    .find("p")
    .html("LKR " + Math.ceil(CryptoData.Portfolio * CryptoData.Worth));
}
        ...
        function (CryptoData) {
          if (CryptoData !== false) {
            ...
            QB.Phone.Notifications.Add(
              "fas fa-university",
              "QBank",
              "LKR " + Price + ",- has been withdrawn from your balance!",
              "#badc58",
              2500
            );
          } else {
          ...
          function (CryptoData) {
            if (CryptoData !== false) {
              ...
              QB.Phone.Notifications.Add(
                "fas fa-university",
                "QBank",
                "LKR " + Price + ",- has been added to your balance!",
                "#badc58",
                2500
              );
            } else {
...
$(".crypto-action-page-buy-crypto-input-coins").keyup(function () {
  ...
  $(".crypto-action-page-buy-crypto-input-money").html(MoneyAmount + " LKR");
});
...
$(".crypto-action-page-sell-crypto-input-coins").keyup(function () {
  ...
  $(".crypto-action-page-sell-crypto-input-money").html(MoneyAmount + " LKR");
});
