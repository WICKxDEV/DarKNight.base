local Translations = {
    ...
    success = {
        ...
        tow_paid = 'You were paid LKR 500',
    ...
    info = {
        ...
        vehicle_taken_depot = 'Vehicle taken into depot for LKR %{price}',
        vehicle_seized = 'Vehicle seized',
        stolen_money = 'You have stolen LKR %{stolen}',
        cash_robbed = 'You have been robbed of LKR %{money}',
        ...
        cash_found = 'Found LKR %{cash} on the civilian',
        sent_jail_for = 'You sent the person to prison for %{time} months',
        fine_received = 'You received a fine of LKR %{fine}',
    ...
    email = {
        ...
        message = 'Dear %{value}. %{value2}, <br /><br />The Central Judicial Collection Agency (CJCA) charged the fines you received from the police.<br />There is <strong>LKR %{value3}</strong> withdrawn from your account.<br /><br />Kind regards,<br />Mr. I.K. Graai',
    },
    commands = {
