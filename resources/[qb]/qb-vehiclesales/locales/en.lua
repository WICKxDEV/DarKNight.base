local Translations = {
    ...
    success = {
        sold_car_for_price = 'You have sold your car for LKR %{value}',
        car_up_for_sale = 'Your car has been put up for sale! Price - LKR %{value}',
    ...
    info = {
        ...
        sell_vehicle_to_dealer = '[~g~E~w~] - Sell Vehicle To Dealer For ~g~LKR %{value}',
        view_contract = '[~g~E~w~] - View Vehicle Contract',
        cancel_sale = '[~r~G~w~] - Cancel Vehicle Sale',
        model_price = '%{value}, Price: ~g~LKR %{value2}',
    ...
    mail = {
        ...
        message = 'You made LKR %{value} from the sale of your %{value2}.',
    }
}
