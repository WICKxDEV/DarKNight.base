                    ...
                    vehicleMenu = {
                        {
                            ...
                            header = getVehBrand():upper() .. ' ' .. getVehName():upper() .. ' - LKR ' .. getVehPrice(),
                        },
                        {
...
RegisterNetEvent('qb-vehicleshop:client:openFinance', function(data)
    local dialog = exports['qb-input']:ShowInput({
        header = getVehBrand():upper() .. ' ' .. data.buyVehicle:upper() .. ' - LKR ' .. data.price,
...
RegisterNetEvent('qb-vehicleshop:client:openCustomFinance', function(data)
    local dialog = exports['qb-input']:ShowInput({
        header = getVehBrand():upper() .. ' ' .. data.vehicle:upper() .. ' - LKR ' .. data.price,
        submitText = Lang:t('menus.submit_text'),
        inputs = {
            {
                type = 'number',
