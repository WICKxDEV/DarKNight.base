local Translations = {
    error = {
        ...
        minimumallowed = "Minimum payment allowed is LKR",
    ...
    success = {
        ...
        earned_commission = "You earned LKR %{amount} in commission",
        gifted = "You gifted your vehicle",
        received_gift = "You were gifted a vehicle",
        soldfor = "You sold your vehicle for LKR ",
        boughtfor = "You bought a vehicle for LKR ",
    },
    menus = {
        ...
        veh_finance_payment = "Payment Amount (LKR)",
        submit_text = "Submit",
