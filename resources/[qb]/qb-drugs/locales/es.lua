local Translations = {
    ...
    info = {
        ...
        drug_offer = "[E] %{bags}x %{drugLabel} por LKR %{randomPrice}? / [G] Rechazar oferta",
        target_drug_offer = "Vender %{bags}x %{drugLabel} for LKR %{randomPrice}?",
        ...
        mystery_man_button = "[E] Comprar / [G] ayuda a tu amigo (LKR 5000)",
