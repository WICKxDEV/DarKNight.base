local Translations = {
    ...
    info = {
        ...
        drug_offer = "[E] %{bags}x %{drugLabel} for LKR %{randomPrice}? / [G] Decline offer",
        target_drug_offer = "Sell %{bags}x %{drugLabel} for LKR %{randomPrice}?",
        ...
        mystery_man_button = "[E] Buy / [G] Help your guy (LKR 5000)",
