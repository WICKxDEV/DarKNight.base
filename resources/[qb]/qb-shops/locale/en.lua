local Translations = {
    ...
    error = {
        ...
        no_deposit = 'LKR %{value} Deposit Required',
        cancelled = 'Cancelled',
    ...
    success = {
        ...
        paid_with_cash = 'LKR %{value} Deposit Paid With Cash',
        paid_with_bank = 'LKR %{value} Deposit Paid From Bank',
        refund_to_cash = 'LKR %{value} Deposit Paid With Cash',
        you_earned = 'You Earned LKR %{value}',
