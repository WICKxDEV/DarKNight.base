local Translations = {
    ...
    success = {
        deposit = 'You paid a LKR %{deposit} deposit!',
        deposit_returned = 'Your LKR %{deposit} deposit has been returned!',
        sold_hotdogs = '%{value} x Hotdog(\'s) sold for LKR %{value2}',
    ...
    info = {
        ...
        sell_dogs = '[~g~7~s~] Sell %{value} x HotDogs for LKR %{value2} / [~g~8~s~] Reject',
        sell_dogs_target = 'Sell %{value} x HotDogs for LKR %{value2}',
