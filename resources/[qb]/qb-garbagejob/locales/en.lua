local Translations = {
    ...
    success = {
        ...
        ["pay_slip"] = "You got LKR %{total}, your payslip %{deposit} got paid to your bank account!",
    },
    target = {
    ...
    info = {
        ...
        ["payslip"] = "Payslip",
        ["not_enough"] = "You have not enough money for the deposit.. Deposit costs are LKR %{value}",
        ["deposit_paid"] = "You have paid LKR %{value} deposit!",
        ...
        ["payout_deposit"] = "(+ LKR %{value} deposit)",
